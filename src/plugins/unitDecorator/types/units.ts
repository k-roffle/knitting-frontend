...
export type STITCH_APPROXIMATION_TYPE =
  typeof STITCH_APPROXIMATION[keyof typeof STITCH_APPROXIMATION];
...
export type ROW_APPROXIMATION_TYPE =
  typeof ROW_APPROXIMATION[keyof typeof ROW_APPROXIMATION];
